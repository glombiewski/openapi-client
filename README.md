...
with geoengine_sys.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = geoengine_sys.DatasetsApi(api_client)
    auto_create_dataset = geoengine_sys.AutoCreateDataset() # AutoCreateDataset | 
