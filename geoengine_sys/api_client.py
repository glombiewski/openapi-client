...
import geoengine_sys.models
from geoengine_sys import rest
from geoengine_sys.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(geoengine_sys.models, klass)
