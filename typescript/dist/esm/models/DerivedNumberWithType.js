 ...
 */
export function instanceOfDerivedNumberWithType(value) {
    let isInstance = true;
...
export function DerivedNumberWithTypeFromJSON(json) {
    return DerivedNumberWithTypeFromJSONTyped(json, false);
}
export function DerivedNumberWithTypeFromJSONTyped(json, ignoreDiscriminator) {
...
export function DerivedNumberWithTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
