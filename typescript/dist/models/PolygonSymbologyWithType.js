...
exports.PolygonSymbologyWithTypeToJSON = exports.PolygonSymbologyWithTypeFromJSONTyped = exports.PolygonSymbologyWithTypeFromJSON = exports.instanceOfPolygonSymbologyWithType = exports.PolygonSymbologyWithTypeTypeEnum = void 0;
 ...
 * @export
 */
exports.PolygonSymbologyWithTypeTypeEnum = {
    Polygon: 'polygon'
};
/**
 * Check if a given object implements the PolygonSymbologyWithType interface.
 */
function instanceOfPolygonSymbologyWithType(value) {
    let isInstance = true;
...
exports.instanceOfPolygonSymbologyWithType = instanceOfPolygonSymbologyWithType;
function PolygonSymbologyWithTypeFromJSON(json) {
    return PolygonSymbologyWithTypeFromJSONTyped(json, false);
}
exports.PolygonSymbologyWithTypeFromJSON = PolygonSymbologyWithTypeFromJSON;
function PolygonSymbologyWithTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PolygonSymbologyWithTypeFromJSONTyped = PolygonSymbologyWithTypeFromJSONTyped;
function PolygonSymbologyWithTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PolygonSymbologyWithTypeToJSON = PolygonSymbologyWithTypeToJSON;
